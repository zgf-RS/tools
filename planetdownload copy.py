...
def main():
    ...
    geopath = '/Users/zgf/Desktop/planet/试审核/105_24_106_25.geojson'
    ...
    for date in dateboth:
        ...
        idlist = {}
        labellist = {}
        idlistpos = f'/Users/zgf/Desktop/planet/试审核/PK_UID_link/{date}/'+'idlist.json'
        labellistpos = f'/Users/zgf/Desktop/planet/试审核/PK_UID_link/{date}/'+'labellist.json'

        
        os.makedirs(f'/Users/zgf/Desktop/planet/试审核/PK_UID_link/{date}', exist_ok = True)
        ...
        region.to_file(f'/Users/zgf/Desktop/planet/试审核/{date}.geojson')
        ...
        parser.add_argument('--region',
            # default=f'/Users/zgf/Desktop/planet/试审核/todownload_geojson/qq/qq{date}.geojson',
            default=f'/Users/zgf/Desktop/planet/试审核/{date}.geojson',
        ...
        parser.add_argument('-o', '--output-dir',default=f'/Users/zgf/Desktop/planet/试审核/{date}',
